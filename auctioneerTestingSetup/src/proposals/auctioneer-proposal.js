...
export const initAuctioneer = async powers => {
    ...
    const {
        ...
        installation: {
            consume: { fakeAuctioneer: auctionInstallation, contractGovernor: contractGovernorInstallation },
        },
        issuer: {
...
export const getManifestForInitAuctioneer = async ({ restoreRef }, { contractRef }) =>
    harden({
        manifest: {
            [initAuctioneer.name]: {
                consume: {
